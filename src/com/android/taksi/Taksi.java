...
public class Taksi extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		send.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				//dialog.show(Taksi.this,"Prosesing","Prosesing");
				getRequest();
			}
		});
	...
	protected Dialog onCreateDialog(int id) {
		...
		case DATE_DIALOG_ID :
			...
			return new DatePickerDialog(Taksi.this, setTanggal, mYear,mMonth , mDay);
			
	
		case TIME_DIALOG_ID :
	
			return new TimePickerDialog(Taksi.this,setWaktu,mHour,mMinute,true);
	...
	private DatePickerDialog.OnDateSetListener setTanggal = new OnDateSetListener() {
		...
		public void onDateSet(DatePicker view, int year, int monthOfYear,
				int dayOfMonth) {
			tanggal.setText(Integer.toString(dayOfMonth)+"-"+Integer.toString(monthOfYear+1)+"-"+Integer.toString(year));
	...
	private TimePickerDialog.OnTimeSetListener setWaktu = new OnTimeSetListener() {
		...
		public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
			// TODO Auto-generated method stub
			waktu.setText(Integer.toString(hourOfDay)+":"+Integer.toString(minute));
		}
	};
	...
	public void getRequest() {
		...
		try {
			...
			post.add(new BasicNameValuePair("alamat", alamat.getText().toString()));
			post.add(new BasicNameValuePair("tanggal", tanggal.getText().toString()));
			post.add(new BasicNameValuePair("waktu", waktu.getText().toString()));
			post.add(new BasicNameValuePair("nope", nope.getText().toString()));
			post.add(new BasicNameValuePair("tujuan", tujuan.getText().toString()));
			post.add(new BasicNameValuePair("jumlah", jumlah.getText().toString()));
			...
			Toast.makeText(Taksi.this, Koneksi.request(response), Toast.LENGTH_LONG).show();
			//
